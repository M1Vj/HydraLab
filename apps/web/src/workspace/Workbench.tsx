...
function ActivityBar({ openPanel, reviewCount }: { openPanel: (id: PanelId) => void; reviewCount: number }) {
  const ids: PanelId[] = ["explorer", "source-discovery", "review-inbox", "research-chat", "agent-runs", "browser", "writing", "citation-evidence", "tasks", "git", "terminal", "exports", "self-evolution", "settings"];
  return (
