...
| AutoResearchClaw (`aiming-lab/AutoResearchClaw`) | unknown / verify before adoption | unknown | reference-only | Studied only; no source copied, vendored or adapted. | cleared-reference | Branch 03-01 reference for staged closed-loop research/autonomy workflow shape, checkpoint/co-pilot concepts and claim-verification inspiration. HydraLab reimplements the safety shell with owned code. |
